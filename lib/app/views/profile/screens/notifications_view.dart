...
import 'package:make_it_happen/app/widgets/settings_switch_tile.dart';
...
class NotificationsView extends GetView<NotificationsController> {
  ...
  Widget build(BuildContext context) {
    return ProfileScaffold(
      ...
      onBottomTap: () => showDemoSaved(
        'Notification preferences were saved for this demo session.',
      ),
      child: Column(
            ...
            () => Column(
              children: [
                ...
                SettingsSwitchTile(
                  ...
                  onChanged: (value) =>
                      controller.learningCourses.value = value,
                ),
                const SizedBox(height: AppDimens.spacing10),
                SettingsSwitchTile(
                  label: 'Mentorship',
                ...
                SettingsSwitchTile(
                  ...
                  onChanged: (value) =>
                      controller.subscriptionPayments.value = value,
                ),
                const SizedBox(height: AppDimens.spacing10),
                SettingsSwitchTile(
