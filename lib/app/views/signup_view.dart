      ...
      child: BottomSheetContainer(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              Text(AppStrings.createAccountTitle, style: AppTextStyles.titleLarge),
              ...
              AppTextField(
                ...
                prefixIcon: const Icon(LucideIcons.user, color: AppColors.textSecondary),
              ),
              ...
              AppTextField(
                ...
                prefixIcon: const Icon(LucideIcons.phone, color: AppColors.textSecondary),
              ),
              const SizedBox(height: AppDimens.spacing12),
              Obx(
                () => AppTextField(
